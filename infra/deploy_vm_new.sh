...
send -- [lindex $argv 3]
send -- " ; mkdir -p /etc/murano/ ; cp murano-api/etc/murano/murano-api.conf.sample "
...
send -- [lindex $argv 3]
send -- " ; cp murano-conductor/etc/murano/murano-repository"
send -- ".conf.sample /etc/murano/murano-repository.conf\n"
expect "@murano"
send -- "/etc/murano/murano-repository.conf /etc/murano/murano-repository.conf.sample"
