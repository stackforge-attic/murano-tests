...
class UISanityTests(UITestCase):
    ...
    def test_create_delete_environment(self):
        ...
        #self.webuilib.page_should_not_have_element('test_create_del_env')
    ...
    def test_edit_environment(self):
        ...
        #self.webuilib.page_should_have_element('edited_env')
    ...
    def test_rename_windows_image(self):
        ...
        #self.page_should_have_element('Windows Server 2012 Standard')
