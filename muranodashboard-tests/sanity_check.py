...
class UISanityTests(UITestCase):
    ...
    def test_018_check_validation_for_hostname_template_field(self):
        ...
        self.fill_field(by.By.ID, field=service+'name', value='demo')
        self.fill_field(by.By.ID, field=service+'unitNamingPattern',
                        value='demo')
        ...
        self.fill_field(by.By.ID, field=service+'dcInstances',
                        value='1')
        next_button = self.elements.get('button', 'Next2')
        self.driver.find_element_by_xpath(next_button).click()

        WebDriverWait(self.driver, 10).until(lambda s: s.find_element(
            by.By.ID, service+'osImage').is_displayed())
    ...
    def test_019_check_bool_field_validation(self):
        ...
        self.fill_field(by.By.ID, sql_cluster+'name', 'ms-sql')
        self.fill_field(by.By.ID, sql_cluster+'adminPassword', 'P@ssw0rd')
        self.fill_field(by.By.ID, sql_cluster+'adminPassword-clone', 'P@ssw0rd')

        self.driver.find_element_by_id(sql_cluster+'externalAD').click()
        self.fill_field(by.By.ID, sql_cluster+'domainAdminUserName', 'user')
        self.fill_field(by.By.ID, sql_cluster+'domainAdminPassword', 'P@ssw0rd')
        self.fill_field(by.By.ID, sql_cluster+'domainAdminPassword-clone',
                        'anotherP@ssw0rd')
        self.fill_field(by.By.ID, sql_cluster+'saPassword', 'P@ssw0rd')
        self.fill_field(by.By.ID, sql_cluster+'saPassword-clone', 'P@ssw0rd')
    ...
    def test_020_positive_scenario_1_for_the_MS_SQL_Cluster_Form(self):
        ...
        self.fill_field(by.By.ID,
                        sql_cluster+'adminPassword-clone', 'P@ssw0rd')

        self.select_from_list(sql_cluster+'domain', 'activeDirectory.mssql')

        self.driver.find_element_by_id(sql_cluster+'mixedModeAuth').click()
